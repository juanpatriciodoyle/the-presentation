...
export const strategyData: { [key: string]: Strategy } = {
    ...
    immersive: {
        ...
        examples: [
            { name: 'Airbnb', desc: 'Uses stunning photography and a warm palette to create an emotional connection and inspire wanderlust.' },
            { name: 'Duolingo', desc: 'Uses gamification and character animations to create a highly motivating and resonant experience.' },
        ],
    },
};